import { Goods, Store, CustomerOutboundRule, Customer, Vehicle, InboundPlan, InboundOrder, StockStat, OutboundPlan, OutboundOrder, AbnormalSignRecord, AbnormalReport } from '../types';
...
export const mockAbnormalSignRecords: AbnormalSignRecord[] = [
  {
    id: '1',
    customerId: '4',
    customerName: '深圳华润万家',
...
export const mockAbnormalReports: AbnormalReport[] = [
  {
    id: '1',
    orderNo: 'RKDBH001202607080001',
    orderType: 'inbound',
    orderTime: '2026-07-08',
    goodsCode: 'MENGNIU',
    goodsName: '蒙牛纯牛奶',
    spec: '250ml*12盒',
    plannedQuantity: 200,
  ...
  {
    id: '4',
    orderNo: 'CKDBH001202607060001',
    orderType: 'outbound',
    orderTime: '2026-07-06',
    goodsCode: 'COKE001',
    goodsName: '可口可乐',
    spec: '500ml',
    plannedQuantity: 150,
